...
export default function Knowledge() {
  useEffect(() => {
    document.title = 'WalletTrail Knowledge — Learn & Research Blockchain';
  }, []);
  ...
  return (
    <main className="knowledge-page">
      ...
      <section className="knowledge-hero">
        <p className="eyebrow">WalletTrail Knowledge</p>
        <h1>Go deeper. Understand the bigger picture.</h1>
        <p>WalletTrail Knowledge is where we build beyond quick definitions and beginner lessons. Explore practical explanations and research that help blockchain and cryptocurrency make more sense.</p>
      </section>

      <section className="knowledge-intro">
        <p className="eyebrow">A growing resource</p>
        <h2>Learn one subject at a time.</h2>
        <p>Not everything can be explained in a definition. Knowledge gives us room to explain how things work, why they matter and what to look at when making sense of blockchain information.</p>
      </section>

      <section className="knowledge-grid" aria-label="Knowledge areas">
      ...
      <section className="knowledge-bridge">
        <p className="eyebrow">Choose your starting point</p>
        <h2>Need a quick answer first?</h2>
        <p>Use the Dictionary for clear explanations of individual blockchain terms. If you are starting from the beginning, WalletTrail 101 will guide you through the fundamentals.</p>
        <div className="knowledge-links">
          <a className="button button-primary" href="/dictionary">Explore the Dictionary</a>
          <a className="text-link" href="/wallettrail-101">Start WalletTrail 101 →</a>
        </div>
      </section>
